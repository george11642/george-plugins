...
- ./new-architecture.md -- SDK +53: New Architecture migration guide
- ./react-19.md -- SDK +54: React 19 changes (useContext -> use, Context.Provider -> Context, forwardRef removal)
- ./react-compiler.md -- SDK +54: React Compiler setup and migration guide
- ./native-tabs.md -- SDK +55: Native tabs changes (Icon/Label/Badge now accessed via NativeTabs.Trigger.*)
- ./expo-av-to-audio.md -- Migrate audio playback and recording from expo-av to expo-audio
- ./expo-av-to-video.md -- Migrate video playback from expo-av to expo-video
